...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/codebrim.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='v7-d6-aux_640_8', help='save to project/name')
