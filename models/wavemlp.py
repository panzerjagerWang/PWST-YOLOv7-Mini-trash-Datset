...
class WaveBlock(nn.Module):
    ...
    def __init__(self, dim, out=128, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp = Mlp(in_features=dim, hidden_features=mlp_hidden_dim, out_features=out, act_layer=act_layer)
